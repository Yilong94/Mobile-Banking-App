...
public class Camera2Activity extends AppCompatActivity {
    ...
    public static final String DATAKEY = "myImageKey";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_camera2);
        //Log.i("yilong", "main activity works");
        ...
        button.setOnClickListener(new View.OnClickListener(){
            public void onClick(View view){
                mCameraSource.stop();
                Log.i("real text", receipt_data);
                Intent intent = new Intent(view.getContext(), ContactsActivity.class);
                intent.putExtra(DATAKEY, receipt_data);
                    ...
                    if (items.size() != 0 ){
                        ...
                        mTextView.post(new Runnable() {
                            ...
                            public void run() {
                                ...
                                receipt_data = stringBuilder.toString();
                            }
                        });
                    }
                }
